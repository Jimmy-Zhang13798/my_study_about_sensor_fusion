...
//Done！Just a very simple struct to show the color of different objects
struct Color
{
...
//Done! Just a very simple struct, which is a 3-dimensiaoal vector
struct Vect3
{
...
// Done! can use this struct to build a car, also it has a function:render, you can use it to render the car in Viewer.
struct Car
{
	...
	// it's used to detect if the ray has reached the car, if point has reached the car, that means there is a collision, the point will stop
