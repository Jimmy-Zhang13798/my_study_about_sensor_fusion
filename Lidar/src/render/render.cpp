...
//Done! it's used to draw line from origin positoin to all points of a pointcloud  
int countRays = 0;
...
// Done! simple function to remove all ray line from screen 
